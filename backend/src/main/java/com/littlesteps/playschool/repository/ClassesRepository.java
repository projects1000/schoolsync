...
public interface ClassesRepository extends MongoRepository<Classes, String> {
    ...
    Page<Classes> findBySchoolIdAndStatusNot(String schoolId, Classes.Status status, Pageable pageable);

    List<Classes> findBySchoolIdAndStatus(String schoolId, Classes.Status status);
    Page<Classes> findBySchoolIdAndStatus(String schoolId, Classes.Status status, Pageable pageable);
