...
const AcademicsManagement = () => {
  ...
  const availableClassTeachers = useMemo(() => {
    ...
    return teachers.filter(
      (t) => !assignedTeacherIds.includes(t.id) || t.id === classTeacherId,
    );
  ...
  const filteredClassTeachers = useMemo(() => {
    ...
    return availableClassTeachers.filter(
      (t) =>
      ...
      prev.map((cs) =>
        cs.subjectId === subjectId
          ? {
              ...
              teacherName:
                teachers.find((t) => t.id === actualTeacherId)?.name ||
                "Unassigned",
            }
          : cs,
      ),
  ...
  const handleAddSubjects = async () => {
    ...
    setSaving(true);
    try {
      await adminService.assignSubjectsToClass(
        selectedClassId,
  ...
  const handleDeleteSubject = async (subjectId) => {
    if (
      !window.confirm(
        "Are you sure you want to delete this subject? It will be removed from all classes.",
      )
    )
      return;
        ...
        <div className="relative flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
            ...
            <p className="text-gray-500 text-lg">
              Orchestrate your school's curriculum and teaching assignments
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <Card className="lg:col-span-4 rounded-3xl border-gray-100 shadow-sm overflow-hidden h-fit">
              <CardHeader className="bg-gray-50/50 border-b border-gray-100 py-6">
                ...
                <CardDescription>
                  Pick a grade and section to manage
                </CardDescription>
              </CardHeader>
              <CardContent className="p-6 space-y-6">
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {[...new Set(classes.map((c) => c.grade || c.name))]
                      .sort()
                      .map((grade) => (
                        <button
                          key={grade}
              ...
              {!selectedClass ? (
                <div className="h-full min-h-[400px] flex flex-col items-center justify-center bg-gray-50/50 rounded-[32px] border-2 border-dashed border-gray-200 text-gray-400 p-8 text-center group">
                  ...
                  <p className="max-w-[280px]">
                    Please select a grade and section from the left panel to
                    begin managing academics.
                  </p>
                </div>
              ) : (
                <motion.div
                  ...
                  <Card className="rounded-[32px] border-none shadow-xl shadow-purple-900/[0.03] overflow-hidden">
                    ...
                    <CardContent className="p-8">
                      <div className="max-w-md space-y-4">
                        ...
                        <Select
                          value={classTeacherId || "_none_"}
                          onValueChange={handleClassTeacherChange}
                        >
                                ...
                                <div className="flex items-center gap-3">
                                  ...
                                  <div className="flex flex-col">
                                    ...
                                    <span className="text-xs text-gray-400">
                                      {teacher.department || "Academic Dept"}
                                    </span>
                                  </div>
                                </div>
                              </SelectItem>
                  ...
                  <div className="space-y-6">
                      ...
                      <div className="flex items-center gap-2">
                        <div className="relative">
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              setSubjectTeacherSearch(e.target.value)
                            }
                        ...
                        <div className="p-6">
                          <div className="flex flex-col gap-1 mb-6">
                            ...
                            <p className="text-sm text-gray-500">
                              Enable additional curriculum for this section
                            </p>
                          </div>
                          ...
                          {selectedSubjectsToAdd.length > 0 && (
                            ...
                            >
                              {saving
                                ? "Processing..."
                                : `Assign ${selectedSubjectsToAdd.length} selected subjects`}
                            </Button>
                          )}
                        </div>
                      </Card>
                    ...
                    {classSubjects.length === 0 ? (
                      <div className="text-center py-20 bg-white rounded-[40px] border-2 border-dashed border-gray-100 shadow-sm">
                        ...
                        <p className="text-gray-400 max-w-sm mx-auto px-4">
                          This section has no subjects assigned. Use the panel
                          above to start building the curriculum.
                        </p>
                      </div>
                    ) : (
                                ...
                                <div className="flex items-center gap-4">
                                  ...
                                  <div>
                                    ...
                                    <div className="flex items-center gap-2 mt-1">
                                      <span
                                        className={`w-2 h-2 rounded-full ${cs.teacherId ? "bg-green-500" : "bg-red-400 animate-pulse"}`}
                                      ></span>
            ...
            <Card className="lg:col-span-4 rounded-[32px] border-none shadow-xl shadow-purple-900/[0.04]">
              <CardHeader className="p-8">
                ...
                <CardDescription className="text-base text-gray-500">
                  Establish a new standard curriculum component
                </CardDescription>
              </CardHeader>
                  ...
                  {newSubjectType === "CLASS_SPECIFIC" && (
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={setNewSubjectTargetGrade}
                      >
                        <SelectTrigger className="h-14 rounded-2xl border-gray-100 bg-gray-50/50 hover:bg-white text-lg">
              ...
              <CardHeader className="p-8 flex flex-row items-center justify-between border-b border-gray-50">
                <div>
                  ...
                  <CardDescription className="text-base">
                    All globally defined subjects for this academy
                  </CardDescription>
                </div>
                      ...
                      >
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <div className="mt-1">
                              <span
                                className={`px-2 py-0.5 rounded-md text-[10px] font-bold tracking-wider ${subject.type === "CLASS_SPECIFIC" ? "bg-orange-100 text-orange-700" : "bg-green-100 text-green-700"}`}
                              >
                                {subject.type === "CLASS_SPECIFIC"
                                  ? `SPECIFIC: ${subject.targetGrade}`
                                  : "UNIVERSAL"}
                              </span>
                            </div>
                          </div>
