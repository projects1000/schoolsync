    ...
    if (!schoolData || !schoolData.school) {
        return (
            <div className="flex flex-col items-center justify-center h-96">
                ...
                <Button onClick={() => navigate('/superadmin/schools')} className="mt-4 bg-indigo-600">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    {school.admin ? (
                                        <div className="bg-purple-50 rounded-lg p-4 flex items-center gap-4 border border-purple-100">
                                            <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center text-purple-600 font-bold shadow-sm">
                    ...
                    {activeTab === 'teachers' && (
                        <div>
                            <div className="flex justify-between items-center mb-4">
                                ...
                                <span className="bg-purple-100 text-purple-700 text-xs font-semibold px-2.5 py-0.5 rounded-full">{totalTeachers} Total</span>
                            </div>
                            <div className="overflow-x-auto">
                                <table className="w-full border-collapse">
                                    <thead>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-xl p-6 text-white shadow-md">
                                    <div className="flex justify-between items-start">
                                        <div>
                                            <p className="text-indigo-100 text-sm font-medium mb-1">Current Subscription Due (Estimated)</p>
                                    ...
                                    <p className="text-xs text-indigo-100 mt-4 opacity-80">Calculated based on active student volume ($10 per active student monthly scale).</p>
                                </div>
                            </div>
                        </div>
                    )}
